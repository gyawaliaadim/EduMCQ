...
export default function Drawer() {
    ...
    const menuItems = [
        { name: "Chapters", href: "/demo/teacherDemo/chapters" },
        { name: "Add MCQ", href: "/demo/teacherDemo/addMCQ" },
        { name: "View All MCQ", href: "/demo/teacherDemo/viewMCQs" },
    ];
    ...
    return (
        <div className="fixed top-0 left-0 min-h-screen sm:w-48 w-20 bg-gray-900 text-white flex flex-col justify-between">
            <div className="flex flex-col">
                ...
                {/* Bottom Profile */}
                <div className="p-2">
                    <Link href="/demo/teacherDemo/profile" className="flex items-center p-2 gap-2 bg-gray-800 h-15 justify-center rounded hover:bg-gray-700">
                        {/* Circle for DP */}
